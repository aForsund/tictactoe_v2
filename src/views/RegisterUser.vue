  ...
  <div class="hero-body">
    <div class="container">
      ...
      <div class="columns is-mobile">
        <div class="column is-three-quarters-mobile is-half-tablet is-one-third-widescreen">
          <p
            class="subtitle"
          >You can add users to the database and search for them in the rankings section</p>
          <div class="field">
